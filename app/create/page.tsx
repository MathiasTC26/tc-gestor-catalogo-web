    ...
    >
      <div className="mb-3 flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <RelatedProductsBlock product={product} compact />
        </div>
    ...
    <article className="overflow-hidden rounded-[16px] border border-[#bdb5b9] bg-[#e9e4e6] shadow-[inset_0_1px_0_rgba(255,255,255,.45)]">
      ...
      <div className="flex gap-3 p-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-[10.5px] font-black text-[#A52E64]">
...
function RelatedProductsBlock({
  ...
  const visibleItems = compact ? relatedProducts.slice(0, 3) : relatedProducts;
  ...
  return (
    ...
    >
      ...
      <ul className="mt-1 grid gap-0.5 text-[10px] font-bold leading-snug text-[#655c61]">
      ...
      {compact && relatedProducts.length > visibleItems.length ? (
        <p className="mt-1 text-[9.5px] font-black text-[#A52E64]">
          +{relatedProducts.length - visibleItems.length} más
        </p>
      ) : null}
    </div>
  );
